...
export default { BannerDiv, BannerImg, InfoDiv, InfoNameDiv, InfoNameP, InfoNameBtn, InfoFollowerDiv, InfoFollowingDiv, InfoFollowP, FollowP, InfoArtistDiv, InfoArtistP }