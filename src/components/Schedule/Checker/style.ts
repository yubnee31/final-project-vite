...
const ScheduleListImg = styled.img`
  ...
  cursor: pointer;
`
export default { ScheduleDiv, ScheduleUl, ScheduleLi, ScheduleDayP, ScheduleListDiv, ScheduleListSection, ScheduleListTimeP, ScheduleListTitleP, ScheduleListImg }